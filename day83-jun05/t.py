...
image_path = r"C:\Users\User-PC\Downloads\New folder\printer-3.jpg"
...
if len(rects) > 0 or len(line_boxes) > 0:
    ...
    # Contract the rectangle by 5% on each side
    widthA = np.sqrt(((rect[2][0] - rect[0][0]) ** 2) + ((rect[2][1] - rect[0][1]) ** 2))
    widthB = np.sqrt(((rect[3][0] - rect[1][0]) ** 2) + ((rect[3][1] - rect[1][1]) ** 2))
    rect[0][0] += 0.05 * widthA
    rect[2][0] -= 0.05 * widthA
    rect[1][0] += 0.05 * widthB
    rect[3][0] -= 0.05 * widthB

    heightA = np.sqrt(((rect[1][0] - rect[2][0]) ** 2) + ((rect[1][1] - rect[2][1]) ** 2))
    heightB = np.sqrt(((rect[0][0] - rect[3][0]) ** 2) + ((rect[0][1] - rect[3][1]) ** 2))
    rect[0][1] += 0.05 * heightA
    rect[2][1] -= 0.05 * heightA
    rect[1][1] += 0.05 * heightB
    rect[3][1] -= 0.05 * heightB
    ...
    cv2.imwrite('cropped_receipt3.jpg', warped)
else:
